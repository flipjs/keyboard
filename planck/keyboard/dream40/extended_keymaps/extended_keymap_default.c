...
[2] = { /* Punctuation */
{KC_TRNS, KC_SLSH, S(KC_1), S(KC_2), S(KC_3), S(KC_8),   S(KC_SCLN), S(KC_QUOT), S(KC_9), S(KC_0), KC_BSLS, KC_TRNS},
{KC_TRNS, KC_MINS, S(KC_4), S(KC_5), S(KC_6), S(KC_EQL), KC_SCLN,    KC_QUOT, S(KC_LBRC), S(KC_RBRC), KC_NO, KC_TRNS},
{KC_TRNS, KC_EQL,  S(KC_7), S(KC_BSLS), S(KC_SLSH), S(KC_MINS), S(KC_GRV), KC_GRV, KC_NO, KC_LBRC, KC_RBRC,  KC_DEL},
{KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS}
},
