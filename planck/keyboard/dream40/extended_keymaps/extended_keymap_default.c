...
{FUNC(12),  KC_A,    KC_S,    KC_D,     KC_F,    KC_G,   KC_H,    KC_J,    KC_K,    KC_L,    KC_NO,   KC_ENT},
{KC_LSFT, KC_Z,    KC_X,     KC_C,     KC_V,    KC_B,   KC_N,    KC_M,    KC_NO,   KC_COMM, KC_DOT,  KC_RSFT},
{KC_LALT, KC_LGUI, FUNC(5),  KC_SPC,   KC_NO,   KC_NO,  FUNC(6), KC_NO,   FUNC(8), KC_NO,   FUNC(7), FUNC(10)}
},
...
{KC_TRNS, KC_TRNS, KC_TRNS, KC_DOT,    KC_NO,      KC_NO,     KC_SPC,    KC_NO,      KC_TRNS,    KC_NO,      KC_TRNS, KC_TRNS}
},

[3] = { /* Number */
{KC_TRNS, KC_SLSH, KC_1, KC_2,    KC_3,  S(KC_8),   S(KC_QUOT), S(KC_9),    S(KC_0),    S(KC_GRV),  KC_BSLS, KC_TRNS},
{KC_DOT, KC_MINS, KC_4, KC_5,    KC_6,  S(KC_EQL), KC_QUOT,    S(KC_LBRC), S(KC_RBRC), S(KC_SLSH), KC_NO,   KC_TRNS},
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [8] = ACTION_LAYER_TAP_KEY(2, KC_SLSH),                               // SlashFn Punctuation
    ...
    [12] = ACTION_MODS_TAP_KEY(MOD_LCTL, KC_TAB),                        // Hold=Ctrl, Tap=Tab
